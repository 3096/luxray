...
// depending on the configuration, use the larger size as layer base
...
#    define LAYER_BASE_WIDTH LAYER_INFO_DOCKED_WIDTH
#    define LAYER_BASE_HEIGHT LAYER_INFO_DOCKED_HEIGHT
#    define LAYER_BUF_LENGTH DOCKED_DOTS_TOTAL
#else
#    define LAYER_BASE_WIDTH LAYER_INFO_HANDHELD_WIDTH
#    define LAYER_BASE_HEIGHT LAYER_INFO_HANDHELD_HEIGHT
#    define LAYER_BUF_LENGTH HANDHELD_DOTS_TOTAL
#endif
